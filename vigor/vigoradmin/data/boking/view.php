        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              echo"<a href='/vigor/gambar/transfer_img/$_data[transfer]'>$_data[transfer]</a>";
                }else{
              echo"-";	  
              }
              echo"</td>
              ...
              echo"</td>
                ...
                echo"
                      <a href='?load=boking&action=edit-boking&kdBoking=$_data[kdBoking]'><button class='btn btn-primary btn-mini'> <i class='icon-eye-open'></i> &nbsp; Edit</button></a> 
                      <a href='?load=boking&action=edit&id=$_data[kdBoking]'><button class='btn btn-primary btn-mini'> <i class='icon-eye-open'></i> &nbsp; Details</button></a>
                      <a href='$loadModule?load=boking&action=hapusData&id=$_data[kdBoking]'><button class='btn btn-danger btn-mini'><i class='icon-trash'></i> &nbsp; Delete</button></a>
                   ";	  
                }
...
function downloadFile(fileName){	
	window.open("/gambar/transfer_img/"+fileName, "_blank");
}
});
</script>