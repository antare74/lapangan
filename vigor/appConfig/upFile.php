...
}function upTransfer($upImage_name){
  //direktori gambar
  $upDir = "gambar/transfer_img/";
  $upFile = $upDir . $upImage_name;

  //Simpan gambar dalam ukuran sebenarnya
  move_uploaded_file($_FILES["upPhoto"]["tmp_name"], $upFile);
  

  //identitas file asli
  $imgSrc = imagecreatefromjpeg($upFile);
